...
#                print monster_name(monster['unit_master_id']), ": ", monster
            fm.write(u"%s,%s,%s,%s,%s,%s,%d,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%d,%s,%s,%s,%s,%s,%s,%s,%s,%s\n" %
                     (friend['wizard_name'].encode('ascii', 'replace'),
                      ...
                      monster_attribute(monster['attribute']),
                      "Yes" if monster['building_id'] == storage_id else "No",
                      (int(monster['con']) * 15) + rune_addition(monster_runes, 'con', monster['con']*15) + (rune_sets[0] * .15 * monster['con'] * 15),
                      monster['atk'] + rune_addition(monster_runes, 'atk', monster['atk']) + (rune_sets[7] * .35 * monster['atk']),
                      monster['def'] + rune_addition(monster_runes, 'def', monster['def']) + (rune_sets[1] * .15 * monster['def']),
                      monster['spd'] + rune_addition(monster_runes, 'spd', monster['spd']) + (rune_sets[2] * .25 * monster['spd']),
